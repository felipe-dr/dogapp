	...
	*/
	...
	var Request$1 = /*#__PURE__*/function () {
	  ...
	  _createClass(Request, [{
	    key: "fetchUrl",
	    value: function () {
	      var _fetchUrl = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
	...
	var SettingStyles = /*#__PURE__*/function () {
	  function SettingStyles(config, listBreeds, listColors, listFontFamily, resultDogName, resultDogImage, btnSaveConfig) {
	    _classCallCheck(this, SettingStyles);
	    ...
	    this.handleStyle = {
	      ...
	      breed: function breed() {
	        ...
	        setTimeout(function () {
	          _this.methodGetBreedImg();
	        }, 50);
	      },
	      dogName: function dogName(value) {
	  ...
	  _createClass(SettingStyles, [{
	    key: "startHandleStyleRender",
	    value: function startHandleStyleRender() {
	    ...
	    key: "randomBreedImg",
	    value: function randomBreedImg(listBreed) {
	    ...
	    key: "getBreedImg",
	    value: function () {
	      var _getBreedImg = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
	        var selectedBreed, url, request, objImg;
	        return regeneratorRuntime.wrap(function _callee$(_context) {
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	                selectedBreed = this.listBreeds.options[this.listBreeds.selectedIndex].value;
	                url = "https://dog.ceo/api/breed/".concat(selectedBreed, "/images"); // Variáveis da requisição

	                request = new Request$1(url);
	                _context.next = 5;
	                return request.fetchUrl();

	              case 5:
	                objImg = request.jsonData.message; // Adiciona tag img com a url da requisição

	                this.resultDogImage.innerHTML = "<img src=\"".concat(objImg[this.randomBreedImg(objImg.length)], "\" alt=\"").concat(this.listBreeds.options[this.listBreeds.selectedIndex].value, "\" />");
	      ...
	      function getBreedImg() {
	        return _getBreedImg.apply(this, arguments);
	      }
	    ...
	    key: "crateDataList",
	    value: function () {
	      var _crateDataList = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
	        var request, objBreeds, optionValues;
	        return regeneratorRuntime.wrap(function _callee2$(_context2) {
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              case 0:
	                // Variáveis da requisição
	                request = new Request$1('https://dog.ceo/api/breeds/list/all');
	                _context2.next = 3;
	                return request.fetchUrl();

	              case 3:
	                objBreeds = request.jsonData.message; // Variáveis da lista

	                Object.keys(objBreeds).forEach(function (key) {
	                  optionValues += "<option value=\"".concat(key, "\">").concat(key, "</option>");
	      ...
	      function crateDataList() {
	        return _crateDataList.apply(this, arguments);
	      }
	    ...
	    value: function createMessageStatus(element, text, className, showTime) {
	      var _this2 = this;

	      var valid = document.querySelector(".".concat(className));
	      ...
	      if (!valid) {
	        ...
	        setTimeout(function () {
	          _this2.config.removeChild(domElement);
	        }, showTime);
	      }
	    ...
	    key: "saveConfig",
	    value: function saveConfig(event) {
	      event.preventDefault();
	      this.handleConfig = {};
	      var formElements = this.config;
	      ...
	      var status = localStorage.config ? 'Configurações armazenadas com Sucesso' : 'Erro ao tentar salvar'; // Fornece dados para a criação da mensagem

	      this.createMessageStatus('span', "".concat(status), 'c-status', 2000);
	    ...
	    value: function setConfig() {
	      ...
	      if (localStorage.config) {
	        var storedConfig = JSON.parse(localStorage.config);
	        var keys = Object.keys(storedConfig);
	        keys.forEach(function (key) {
	          _this3.handleStyle[key](storedConfig[key]);

	          _this3.config.elements[key].value = storedConfig[key];
	        });
	      }
	    } // Inicialização
	  ...
	  return SettingStyles;
	}();

	// Imports
	var settingStyles = new SettingStyles('[data-setting="config"]', '[data-setting="listBreeds"]', '[data-setting="listColors"]', '[data-setting="listFontFamily"]', '[data-setting="resultDogName"]', '[data-setting="resultDogImage"]', '[data-setting="saveConfig"]');
	settingStyles.init();
